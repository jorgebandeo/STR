...
void main (int argc, char *argv[]) {
  ...
  double cpu_time_used=0, inputlag=0, read_image_name=0,ASFM=0,RIM=0,process_image=0,CTRI=0,write_image=0,disallocate_storage=0, Lut = 0;
 ...
 for (i=0; i<PGMImage->x; i++)
  ...
  Lut = Lut + ((double)(clock() - start))/CLOCKS_PER_SEC; 
  /* ---- process image ---------------------------------------------------------------- */
  start = clock();
  for (i=1; i<=imax; i++)
    {
